...
namespace EmailService
{
    public class EmailSender : IEmailSender
    {
        ...
        public void SendEmail(Message message , Guid id)
        {
        ...
        public async Task SendEmailAsync(Message message , Guid id)
        {
        ...
        private MimeMessage CreateEmailMessage(Message message , Guid id)
        {
        ...
        private string CreateBody(Guid id) 
        {
